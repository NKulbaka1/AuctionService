...
public class KafkaProducerConfig {
    ...
    private static final String JSON_SERIALIZER =
    ...
    @Bean
    public ProducerFactory<String, BidPlacedEvent> producerFactory() {
    ...
    @Bean
    public KafkaTemplate<String, BidPlacedEvent> kafkaTemplate() {
